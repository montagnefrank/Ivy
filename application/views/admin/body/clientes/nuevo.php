        ...
        <div class="modal-body">
            <div class="col-md-13"><div class="mensaje_error" style="display: none"></div></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">  
                        <div class="form-group">
                          <label for="movilc" class="col-sm-3 control-label">Fecha de Cumplea&#241;os</label>
                          <div class="col-sm-9">
                              <input type="date" class="form-control" id="movilc" name="movilc" placeholder="Fecha de Cumplea&#241;os">
                          </div>
                        </div>
                    </div>
                    <div class="col-md-12">

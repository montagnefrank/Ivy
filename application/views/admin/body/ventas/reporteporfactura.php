<div id="page-wrapper">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="" id="form_porFactura" method="post" action="<?php echo site_url($this->package.'/ventas/porFactura/buscar'); ?>"> 
             <div class="row">
                    <div class="col-md-3">  
    ...
    <?php if(isset($reporte)) { ?>  
      <div class="row">
      <div class="col-md-12">
          <h3 class="page-header">Reporte Ventas por Producto</h3>
      </div>
